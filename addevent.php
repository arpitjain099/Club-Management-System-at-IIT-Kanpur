...
<html>
<head><link rel="stylesheet" type="text/css" href="background.css"><title>Add new event</title>
...
<br><a href="javascript:javascript:history.go(-1)">Click here to go back to previous page</a>
	</body>
</html>
