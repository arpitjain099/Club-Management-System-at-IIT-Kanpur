...
<?php session_start();if(!($_SESSION['user']=='root' || $_SESSION['user']=='normal'))die('<h3><center><br><br>You got here because you tried to access this page directly.<br><br>Please make the entry again !<br><br> <a href="index.php">Click</a> here to
go to the login panel.</center></h3>' . mysql_error()); ?>
<html>
<head><title>Add Secretary Records</title><script type="text/javascript">function cleardata(){<?php
