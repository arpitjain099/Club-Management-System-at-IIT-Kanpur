...
if (mysqli_connect_errno($con))
  ...
  $a4=$_POST["email"];
  $a5=$_POST["index"];
  $sql1="INSERT INTO eventassist VALUES('$a1','$a2','$a3','$a4','$a5');";
...
?>
<a href="eventassists.php">click</a> here to go to add more Event Assists!<br><a href="javascript:javascript:history.go(-1)">Click here to go back to previous page</a>